...
app.controller('MenuCtrl', ["$scope", "$ionicModal", "$timeout", "$ionicPopup", "DataService", "$rootScope", "ParseFactory", function($scope, $ionicModal, $timeout,$ionicPopup,DataService,$rootScope,ParseFactory) {

...
app.controller('MainCtrl',["$scope", "BookmarkFactory", "DataService", "$rootScope", "$ionicPlatform", "$ionicPopup", function($scope,BookmarkFactory,DataService,$rootScope,$ionicPlatform,$ionicPopup){
  /*Scope vars*/
